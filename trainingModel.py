...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            X,Y=preprocessor.separate_label_feature(data,label_column_name='cardio')
            ...
            for i in list_of_clusters:
                ...
                x_sampled, y_sampled = rdsmple.fit_sample(cluster_features, cluster_label)

                # splitting the data into training and test set for each cluster one by one
                x_train, x_test, y_train, y_test = train_test_split(x_sampled, y_sampled, test_size=1 / 3, random_state=355)
