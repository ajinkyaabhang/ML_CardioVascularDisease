...
class Preprocessor:
    ...
    def dropOutliers(self,data):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,'Dropping Outliers is failed. Exited the dropOutliers method of the Preprocessor class')
            raise Exception()
    ...
    def dataProcessor(self,data):
        """
                        ...
                        Revisions: None
                                ...
                                """
        self.logger_object.log(self.file_object, 'Entered the dataProcessor method of the Preprocessor class')
        try:
            ...
            self.logger_object.log(self.file_object,'Exception occured in dataProcessor method of the Preprocessor class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,'Data Processing is failed. Exited the dataProcessor method of the Preprocessor class')
            raise Exception()
